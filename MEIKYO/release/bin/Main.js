...
kumite.framebuffereffect.Config = function(p) { if( p === $_ ) return; {
	...
	this.clearLayer2.color = new Color(1,1,1,0.15);
...
kumite.spritemesh.SpriteMeshLayer.max = 10000;
