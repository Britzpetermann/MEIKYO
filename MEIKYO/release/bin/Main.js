...
kumite.framebuffereffect.FBScene.prototype.sceneInit = function(scene) {
	...
	scene.addLayer(new kumite.scene.DelegateLayer(this.fbClearLayer1,kumite.layer.LayerId.CLEAR));
