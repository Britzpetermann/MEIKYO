...
bpmgl.Matrix4TestCase = function(p) { if( p === $_ ) return; {
	TestCase2.call(this);
}}
...
bpmgl.Matrix4TestCase.prototype.matrixEquals = function(expected,description,m) {
	if(expected != null) {
		this.assertEquals(expected.toString(),m.toString(),{ fileName : "Matrix4TestCase.hx", lineNumber : 9, className : "bpmgl.Matrix4TestCase", methodName : "matrixEquals"});
	}
	else {
		this.assertEquals("[Matrix4:  | " + description + " | ]",m.toString(),{ fileName : "Matrix4TestCase.hx", lineNumber : 13, className : "bpmgl.Matrix4TestCase", methodName : "matrixEquals"});
	}
}
bpmgl.Matrix4TestCase.prototype.__class__ = bpmgl.Matrix4TestCase;
bpmgl.TestMatrix4Creations = function(p) { if( p === $_ ) return; {
...
bpmgl.TestMatrix4Operations = function(p) { if( p === $_ ) return; {
	bpmgl.Matrix4TestCase.call(this);
}}
...
bpmjs.TestProgressMonitor = function(p) { if( p === $_ ) return; {
	TestCase2.call(this);
}}
...
bpmgl.TestMatrix4Basics = function(p) { if( p === $_ ) return; {
	bpmgl.Matrix4TestCase.call(this);
}}
...
bpmgl.TestMatrix4Append = function(p) { if( p === $_ ) return; {
	bpmgl.Matrix4TestCase.call(this);
}}
