...
kumite.webworker.WorkingInstanceImpl = function(p) {
	if( p === $_ ) return;
	var instance = new bpmjs.WorkingInstance(this);
}
kumite.webworker.WorkingInstanceImpl.__name__ = ["kumite","webworker","WorkingInstanceImpl"];
kumite.webworker.WorkingInstanceImpl.main = function() {
	new kumite.webworker.WorkingInstanceImpl();
}
kumite.webworker.WorkingInstanceImpl.prototype.init = function() {
}
kumite.webworker.WorkingInstanceImpl.prototype.configure = function(a,b,c) {
	return [a * 2,b * 2,c * 2];
}
kumite.webworker.WorkingInstanceImpl.prototype.render = function(buffer) {
}
kumite.webworker.WorkingInstanceImpl.prototype.__class__ = kumite.webworker.WorkingInstanceImpl;
Reflect = function() { }
...
js.Lib.onerror = null;
kumite.webworker.WorkingInstanceImpl.main()