...
bpmjs.WorkingInstance.__name__ = true;
...
kumite.webworker.WorkingInstanceImpl = function() {
	var instance = new bpmjs.WorkingInstance(this);
};
kumite.webworker.WorkingInstanceImpl.__name__ = true;
kumite.webworker.WorkingInstanceImpl.main = function() {
	new kumite.webworker.WorkingInstanceImpl();
}
kumite.webworker.WorkingInstanceImpl.prototype = {
	...
	,__class__: kumite.webworker.WorkingInstanceImpl
}
