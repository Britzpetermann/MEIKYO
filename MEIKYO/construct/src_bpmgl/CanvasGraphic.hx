...
class CanvasGraphic
{
	...
	public function drawImage(image : HTMLImageElement, dx, dy, dw, dh)
	{
		context.drawImage(image, dx, dy, dw, dh);
	}

	public function drawImage2(image : HTMLImageElement, dx, dy)
	{
		context.drawImage(image, dx, dy);
	}
	
	public function drawImage3(image : HTMLImageElement)
	{
